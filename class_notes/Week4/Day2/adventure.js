...
//         console.log(q);
//         items.innerHTML += q.quotes;
//         // if (q.name == 'finn') {
//         //     items.innerHTML += 'https://vignette.wikia.nocookie.net/adventuretimewithfinnandjake/images/7/7e/Finn_with_bionic_arm-0.png/revision/latest?cb=20190807133126'
//         // } else {
//         //     items.innerHTML = q.name;
//         // }
//         quotes.appendChild(items);
//     }

// }

// fetch('https://adventure-time-quote-api.glitch.me/api/quotes/')
//     .then(data => data.json())
//     .then(json => {
//         console.log(json)
//         display(json)
